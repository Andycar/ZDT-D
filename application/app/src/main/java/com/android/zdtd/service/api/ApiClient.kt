...
class ApiClient(
  ...
  fun createProfile(programId: String, profile: String? = null): Boolean {
    ...
    if (programId == "myproxy" || programId == "myprogram" || programId == "openvpn" || programId == "tun2socks" || programId == "myvpn" || programId == "mihomo" || programId == "mieru" || programId == "hysteria2" || programId == "amneziawg" || programId == "qwdtt" || programId == "sing-box") {
      val body = JSONObject()
